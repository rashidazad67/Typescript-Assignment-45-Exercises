...
let album1= make_album("Atif Aslam", "Album Title1", 6);
let album2= make_album("Nusrat Fateh Ali Khan", "Album Title2", 7);
let album3= make_album("Mehdi Hassan", "Album Title3");
