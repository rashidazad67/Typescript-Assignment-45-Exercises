...
var guestList = ["Qamar", "Asif", "Waheed"];
var notCome = guestList[2];
console.log(notCome, "will not come in my party.");
guestList.splice(2, 2, "Sana");
guestList.forEach(function (guest) { return console.log("Assalam O Alaikum ".concat(guest, ", I Would like to invite you with your family at my Home.")); });
